...
def main():
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        all_type_ids = torch.tensor([f.type_id for f in eval_features], dtype=torch.long)
        eval_data = TensorDataset(all_input_ids, all_input_mask, all_label_ids, all_label_poss, all_type_ids)
        ...
        res_list = []
        for input_ids, input_mask, label_ids, label_poss, type_ids in tqdm(eval_dataloader, desc="Evaluating"):
